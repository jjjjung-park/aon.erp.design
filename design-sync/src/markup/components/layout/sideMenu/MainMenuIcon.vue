<template>
  <UiSidebarGroup class="flex-col p-0 ">
    <template v-for="item in items" :key="item.title">
      <UiSidebarMenuButton  class="flex items-center relative justify-center size-16 hover:cursor-pointer hover:bg-transparent text-neutral/40 hover:text-neutral active:bg-transparent active:text-neutral data-[active=true]:bg-transparent data-[active=true]:text-neutral"
