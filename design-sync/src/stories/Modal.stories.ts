...
export const ConfirmModal: Story = {
  ...
  render: () => ({
    template: `
      <div class="bg-background rounded-md shadow-bottom min-w-120 flex flex-col">
        <div class="flex justify-between items-center px-4 h-14 shrink-0">
          <span class="font-bold text-sm">등록하시겠습니까?</span>
          <UiButton variant="ghost" size="icon"><LucideX /></UiButton>
        </div>
        <div class="px-6 py-2">
...
export const DeleteModal: Story = {
  ...
  render: () => ({
    template: `
      <div class="bg-background rounded-md shadow-bottom min-w-120 flex flex-col">
        <div class="flex justify-between items-center px-4 h-14 shrink-0">
          <span class="font-bold text-sm">삭제하시겠습니까?</span>
          <UiButton variant="ghost" size="icon"><LucideX /></UiButton>
        </div>
        <div class="px-6 py-2">
