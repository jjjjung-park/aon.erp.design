...
<template>
  <SelectTrigger
    ...
    :class="cn(
      'border-border data-[placeholder]:text-disabled-text [&_svg:not([class*=\'text-\'])]:text-muted flex w-fit items-center justify-between gap-2 rounded-sm border bg-transparent px-padding-md text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none  aria-invalid:border-danger aria-invalid:border-2 dark:aria-invalid:ring-destructive/40  dark:bg-inputs/30 dark:hover:bg-inputs/50 focus-visible:border-primary ' +
