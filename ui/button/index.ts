...
export const buttonVariants = cva(
    ...
    " aria-invalid:ring-danger/20 dark:aria-invalid:ring-danger/40 aria-invalid:border-danger focus-visible:ring-ring/50 focus-visible:ring-[2px] ",
    {
      variants: {
        ...
        size: {
          "sm":           " min-w-[40px] h-6 [&_svg:not([class*='size-'])]:size-3 [&_svg.lucide]:[stroke-width:calc(var(--shape-stroke-xs)*2)] px-padding-xs text-xs",
          "default":      "min-w-[64px] h-8 py-2 [&_svg:not([class*='size-'])]:size-4 [&_svg.lucide]:[stroke-width:calc(var(--shape-stroke-sm)*1.5)] px-padding-xs ",
          "lg":           "min-w-[104px] h-10 [&_svg:not([class*='size-'])]:size-4 [&_svg.lucide]:[stroke-width:calc(var(--shape-stroke-sm)*1.5)] px-padding-xs text-md",
          "icon-sm":      "size-6 [&_svg:not([class*='size-'])]:size-3 [&_svg.lucide]:[stroke-width:calc(var(--shape-stroke-xs)*2)]",
          "icon":         "size-8 [&_svg:not([class*='size-'])]:size-4 [&_svg.lucide]:[stroke-width:calc(var(--shape-stroke-sm)*1.5)]",
          "icon-lg":      "size-10 [&_svg:not([class*='size-'])]:size-6 ",
          "inline-icon":  "size-4 [&_svg:not([class*='size-'])]:size-4 [&_svg.lucide]:[stroke-width:calc(var(--shape-stroke-sm)*1.5)]",
          "inline-icon-sm": "size-3 [&_svg:not([class*='size-'])]:size-3 [&_svg.lucide]:[stroke-width:calc(var(--shape-stroke-xs)*2)]",
        },
      },
      defaultVariants: {
        variant: "default",
