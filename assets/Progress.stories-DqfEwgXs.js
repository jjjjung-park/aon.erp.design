const x={title:"기초/Progress",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{modelValue:{control:{type:"range",min:0,max:100},description:"진행률 (0~100)"}},args:{modelValue:40}},e={name:"Progress — 인터랙티브",render:n=>({setup(){return{args:n}},template:'<UiProgress :model-value="args.modelValue" class="w-80" />'})},s={name:"Progress — 단계별",render:()=>({template:`
