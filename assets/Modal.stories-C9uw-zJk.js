import{bM as s}from"./iframe-RcI2tPm4.js";import"./preload-helper-FI0fEOG2.js";const c={title:"UI 패턴/Modal",tags:["autodocs"],parameters:{layout:"centered"}},e={name:"Index",argTypes:{title:{control:"text",description:"모달 제목"},footer:{control:"boolean",description:"하단 footer 표시"},fullScreen:{control:"boolean",description:"전체화면 버튼 표시"},width:{control:"text",description:"모달 너비  (기본 480px / 샘플: 480px · 600px · 720px · 960px)"},actionLabel:{control:"text",description:"우측 버튼 텍스트"},actionVariant:{control:"select",options:["default","destructive","secondary","outline"],description:"우측 버튼 타입"}},args:{title:"모달 제목",footer:!0,fullScreen:!1,width:"",actionLabel:"확인",actionVariant:"default"},render:o=>({setup(){const a=s(!1);return{args:o,isFullSize:a}},template:`
      <div
  ...
  argTypes: {
    ...
    width: {
      control: 'text',
      description: '모달 너비  (기본 480px / 샘플: 480px · 600px · 720px · 960px)'
    },
    actionLabel: {
      control: 'text',
...
}`,...(l=(i=e.parameters)==null?void 0:i.docs)==null?void 0:l.source}}};const d=["Index"];export{e as Index,d as __namedExportsOrder,c as default};
