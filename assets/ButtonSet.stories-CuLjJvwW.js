const U={title:"UI 패턴/ButtonSet",tags:["autodocs"],parameters:{layout:"centered"}},t={name:"폼 액션",render:()=>({template:`
...
}`,...(o=(a=t.parameters)==null?void 0:a.docs)==null?void 0:o.source}}};var r,s,u;n.parameters={...n.parameters,docs:{...(r=n.parameters)==null?void 0:r.docs,source:{originalSource:`{
  name: '아이콘',
  render: () => ({
    template: \`
      <div class="flex items-center gap-1">
...
}`,...(d=(c=e.parameters)==null?void 0:c.docs)==null?void 0:d.source}}};const B=["FormActions","IconGroup","SearchFilter"];export{t as FormActions,n as IconGroup,e as SearchFilter,B as __namedExportsOrder,U as default};
