const b={title:"기초/Checkbox",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{disabled:{control:"boolean",description:"비활성화"},showLabel:{control:"boolean",description:"라벨 표시"},label:{control:"text",description:"라벨 텍스트"}},args:{disabled:!1,showLabel:!0,label:"체크박스 라벨"}},e={name:"Checkbox",render:r=>({setup(){return{args:r}},template:`
