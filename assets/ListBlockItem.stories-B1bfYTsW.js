const a={title:"데이터 표시/리스트/ListBlockItem",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{collapsible:{control:"boolean",description:"접기/펼치기 구조"},dnd:{control:"boolean",description:"드래그 앤 드롭 핸들"},dndState:{control:"radio",options:["기본","dragging","drag-base","drag-target"],description:"DnD 상태 (dnd가 true일 때)"},active:{control:"boolean",description:"활성 상태"},icon:{control:"boolean",description:"아이콘 표시",if:{arg:"collapsible",truthy:!1}},editButton:{control:"boolean",description:"편집/삭제 버튼 표시(마우스 호버)"},label:{control:"text",description:"아이템 텍스트"}},args:{collapsible:!1,dnd:!1,dndState:"기본",active:!1,icon:!1,editButton:!1,label:"항목 이름"}},t={name:"ListBlockItem",render:l=>({setup(){return{args:l}},template:`
      <!-- 기본 / DnD -->
