const i={title:"기초/Switch",tags:["autodocs","done"],parameters:{layout:"centered"},argTypes:{disabled:{control:"boolean",description:"비활성화"},showLabel:{control:"boolean",description:"라벨 표시"},label:{control:"text",description:"라벨 텍스트"},labelPosition:{control:"radio",options:["left","right"],description:"라벨 위치"}},args:{disabled:!1,showLabel:!0,label:"label text",labelPosition:"right"}},e={name:"Switch",render:l=>({setup(){return{args:l}},template:`
