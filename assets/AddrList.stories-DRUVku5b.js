const d={title:"데이터 표시/리스트/AddrList",tags:["autodocs"],parameters:{layout:"centered"}},s={name:"기본",render:()=>({template:`
      <ul class="w-120 px-6">
        <li class="addr-list">
    ...
    `})};var a,l,t;s.parameters={...s.parameters,docs:{...(a=s.parameters)==null?void 0:a.docs,source:{originalSource:`{
  name: '기본',
  render: () => ({
    template: \`
      <ul class="w-120 px-6">
...
}`,...(t=(l=s.parameters)==null?void 0:l.docs)==null?void 0:t.source}}};const i=["Default"];export{s as Default,i as __namedExportsOrder,d as default};
