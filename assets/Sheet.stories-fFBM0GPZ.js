import{_ as s}from"./SheetBase--ZpOsxRK.js";import{x as l}from"./iframe-DooHc6g7.js";import"./preload-helper-FI0fEOG2.js";const v={title:"오버레이/Sheet",component:s,parameters:{layout:"fullscreen"},argTypes:{title:{control:"text",description:"시트 제목"},description:{control:"text",description:"시트 서브 타이틀"},fullScreen:{control:"boolean",description:"전체화면 여부"},footer:{control:"boolean",description:"하단 footer 표시 여부"},dimmed:{control:"boolean",description:"배경 딤 처리"},isLooading:{control:"boolean",description:"로딩 상태"}},args:{title:"시트 제목",description:"서브 타이틀",fullScreen:!1,footer:!0,dimmed:!1,isLooading:!1}},n=`
