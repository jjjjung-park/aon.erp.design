const a={title:"UI 패턴/Stepper",tags:["autodocs","unused"],parameters:{layout:"centered"},argTypes:{step:{control:"radio",options:[1,2,3],description:"현재 단계"}},args:{step:2}},i=[{title:"기본 정보",description:"상품명, 카테고리"},{title:"상세 정보",description:"옵션, 가격 설정"},{title:"완료",description:"등록 확인"}],e={name:"단계별",render:r=>({setup(){return{args:r,steps:i}},template:`
