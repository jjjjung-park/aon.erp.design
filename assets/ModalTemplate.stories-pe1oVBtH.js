import{_ as R}from"./PageSearch-CWXdKZYZ.js";import{T as A}from"./TablePagination-CxulSNKp.js";import"./iframe-RcI2tPm4.js";import"./preload-helper-FI0fEOG2.js";import"./ModalBase-zATy2rHv.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const J={title:"레이아웃/Modal/템플릿",tags:["autodocs"],parameters:{layout:"centered"}},c=(e,M,d,q="w-120")=>`
  <div class="bg-background rounded-md shadow-bottom flex flex-col ${q}">
    ...
    ${d?`<div class="flex justify-between gap-2 p-4 shrink-0"><UiButton variant="outline">닫기</UiButton>${d}</div>`:""}
  </div>
`,p=`
...
`,t={name:"유저 모달 (360px)",render:()=>({template:`
    ...
    `})},i={name:"컨펌/삭제 모달 (480px)",render:()=>({template:`
    ...
    `})},s={name:"폼 모달 (480px)",render:()=>({template:`
      ${c("항목명",`
        <form class="py-2">
          <FormItem label="항목명" placeholder="항목명 입력" />
        </form>
      `,"<UiButton>저장</UiButton>")}
    `})},a={name:"파일 업로드 모달 (480px)",render:()=>({template:`
    ...
    `})},l={name:"주소 모달 (480px)",render:()=>({components:{TablePagination:A},template:`
    ...
    `})},n={name:"설정 모달 (360px / 720px)",render:()=>({setup(){return{variants:[!0,!1]}},template:`
    ...
    `})},o={name:"이미지 업로드 모달 (720px)",render:()=>({setup(){return{images:[{state:"deleted",src:"/src/assets/images/sample/clothes.png"},{state:"success",src:"/src/assets/images/sample/clothes.png"},{state:"error",src:"/src/assets/images/sample/clothes.png"},{state:"default",src:"/src/assets/images/sample/clothes.png"}]}},template:`
    ...
    `})},r={name:"데이터 추가 모달 (1200px)",argTypes:{splitType:{control:"radio",options:["vertical","horizontal"],description:"선택항목 분할 타입"}},args:{splitType:"vertical"},render:e=>({components:{PageSearch:R},setup(){return{args:e}},template:`
      <div :class="['bg-background rounded-md shadow-bottom flex flex-col w-modal-lg', args.splitType === 'vertical' ? 'h-[620px]' : '']">
        <div class="flex justify-between items-center px-4 h-14 shrink-0">
    ...
    `})};var u,v,g;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  name: '유저 모달 (360px)',
  render: () => ({
    template: \`
      <div class="bg-background rounded-md shadow-bottom flex flex-col w-90">
...
}`,...(g=(v=t.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};var m,x,f;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  name: '컨펌/삭제 모달 (480px)',
  render: () => ({
    template: \`
      <div class="flex flex-col gap-6">
...
}`,...(f=(x=i.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};var h,b,U;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  name: '폼 모달 (480px)',
  render: () => ({
    template: \`
      \${shell('항목명', \`
...
}`,...(U=(b=s.parameters)==null?void 0:b.docs)==null?void 0:U.source}}};var B,y,z;a.parameters={...a.parameters,docs:{...(B=a.parameters)==null?void 0:B.docs,source:{originalSource:`{
...
}`,...(z=(y=a.parameters)==null?void 0:y.docs)==null?void 0:z.source}}};var w,_,T;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: '주소 모달 (480px)',
  render: () => ({
    components: {
      TablePagination
...
}`,...(T=(_=l.parameters)==null?void 0:_.docs)==null?void 0:T.source}}};var L,k,C;n.parameters={...n.parameters,docs:{...(L=n.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(C=(k=n.parameters)==null?void 0:k.docs)==null?void 0:C.source}}};var j,P,E;o.parameters={...o.parameters,docs:{...(j=o.parameters)==null?void 0:j.docs,source:{originalSource:`{
  name: '이미지 업로드 모달 (720px)',
  render: () => ({
    setup() {
      const images = [{
        state: 'deleted',
        src: '/src/assets/images/sample/clothes.png'
      }, {
        state: 'success',
        src: '/src/assets/images/sample/clothes.png'
      }, {
...
}`,...(E=(P=o.parameters)==null?void 0:P.docs)==null?void 0:E.source}}};var H,I,S;r.parameters={...r.parameters,docs:{...(H=r.parameters)==null?void 0:H.docs,source:{originalSource:`{
...
}`,...(S=(I=r.parameters)==null?void 0:I.docs)==null?void 0:S.source}}};const K=["UserModal","ConfirmDelete","FormModal","FileUploadModal","AddrModal","SettingModal","ImageUploadModal","DataAddModal"];export{l as AddrModal,i as ConfirmDelete,r as DataAddModal,a as FileUploadModal,s as FormModal,o as ImageUploadModal,n as SettingModal,t as UserModal,K as __namedExportsOrder,J as default};
