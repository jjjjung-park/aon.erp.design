const E={title:"UI 패턴/list/ListBlockItem",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{collapsible:{control:"boolean",description:"접기/펼치기 구조"},dnd:{control:"boolean",description:"드래그 앤 드롭 핸들"},dndState:{control:"radio",options:["기본","dragging","drag-base","drag-target"],description:"DnD 상태 (dnd가 true일 때)"},active:{control:"boolean",description:"활성 상태"},staticBtn:{control:"boolean",description:"스태틱 버튼 — 고스트 (보이기, 핀), 항상 표시"},toggleBtn:{control:"boolean",description:"토글 버튼 — 아웃라인 + destructive (편집), 호버 시 표시"},statusIcon:{control:"radio",options:["없음","완료","오류","신규"],description:"상태 아이콘 — 파일업로드 상태 아이콘"},label:{control:"text",description:"아이템 텍스트"}},args:{collapsible:!1,dnd:!1,dndState:"기본",active:!1,staticBtn:!1,toggleBtn:!1,statusIcon:"없음",label:"항목 이름"}},i={name:"기본",render:q=>({setup(){return{args:q}},template:`
      <!-- 기본 / DnD -->
    ...
    `})},e={name:"Collapsible",render:()=>({template:`
      <div class="w-[360px] flex flex-col gap-1">
    ...
    `})},t={name:"DnD + Collapsible",render:()=>({template:`
      <div class="w-[360px] flex flex-col gap-1">
        <UiCollapsible class="flex flex-col gap-1" :default-open="true">
          <div class="list-block-item">
            <UiButton variant="ghost" size="icon-sm" class="hover:bg-transparent hover:cursor-grab text-muted"><LucideEqual /></UiButton>
    ...
    `})},l={name:"테이블 설정 (DnD + Collapsible + 스태틱 버튼)",render:()=>({template:`
      <div class="w-[360px] flex flex-col gap-1">
        <UiCollapsible class="flex flex-col gap-1" :default-open="true">
          <div class="list-block-item">
            <UiButton variant="ghost" size="icon-sm" class="hover:bg-transparent hover:cursor-grab text-muted"><LucideEqual /></UiButton>
    ...
    `})},a={name:"분할 메뉴 리스트 (DnD + Collapsible + 토글 버튼)",render:()=>({template:`
      <div class="w-[360px] flex flex-col gap-1">
        <UiCollapsible class="flex flex-col gap-1" :default-open="true">
          <div class="list-block-item">
            <UiButton variant="ghost" size="icon-sm" class="hover:bg-transparent hover:cursor-grab text-muted"><LucideEqual /></UiButton>
    ...
    `})},n={name:"파일 리스트 (상태 아이콘 + 호버 토글 버튼)",render:()=>({template:`
      <div class="w-[360px] flex flex-col gap-1">
    ...
    `})};var c,o,r;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`{
  name: '기본',
  render: args => ({
    setup() {
      return {
...
}`,...(r=(o=i.parameters)==null?void 0:o.docs)==null?void 0:r.source}}};var u,d,v;s.parameters={...s.parameters,docs:{...(u=s.parameters)==null?void 0:u.docs,source:{originalSource:`{
  name: 'DnD',
  render: () => ({
    template: \`
      <ul class="w-[360px]">
...
}`,...(v=(d=s.parameters)==null?void 0:d.docs)==null?void 0:v.source}}};var p,b,g;e.parameters={...e.parameters,docs:{...(p=e.parameters)==null?void 0:p.docs,source:{originalSource:`{
  name: 'Collapsible',
  render: () => ({
    template: \`
      <div class="w-[360px] flex flex-col gap-1">
...
}`,...(g=(b=e.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};var m,U,f;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(f=(U=t.parameters)==null?void 0:U.docs)==null?void 0:f.source}}};var x,B,h;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
...
}`,...(h=(B=l.parameters)==null?void 0:B.docs)==null?void 0:h.source}}};var k,_,z;a.parameters={...a.parameters,docs:{...(k=a.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(z=(_=a.parameters)==null?void 0:_.docs)==null?void 0:z.source}}};var C,L,y;n.parameters={...n.parameters,docs:{...(C=n.parameters)==null?void 0:C.docs,source:{originalSource:`{
...
}`,...(y=(L=n.parameters)==null?void 0:L.docs)==null?void 0:y.source}}};const T=["Default","Dnd","Collapsible","DndAndCollapsible","TableSettings","SplitMenuList","FileList"];export{e as Collapsible,i as Default,s as Dnd,t as DndAndCollapsible,n as FileList,a as SplitMenuList,l as TableSettings,T as __namedExportsOrder,E as default};
