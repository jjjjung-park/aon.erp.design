const b={title:"UI 패턴/Collapsible",tags:["autodocs"],parameters:{layout:"centered"}},r={title:"메뉴",subItems:[{title:"하위 메뉴 1",childItem:[{title:"세부 항목 1",isActive:!0},{title:"세부 항목 2",isActive:!1},{title:"세부 항목 3",isActive:!1}]},{title:"하위 메뉴 2",childItem:null},{title:"하위 메뉴 3",childItem:null}]},e={name:"사이드 메뉴",render:()=>({setup(){return{menuData:r}},template:`
    ...
    `})};var i,t,a;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  name: '사이드 메뉴',
  render: () => ({
    setup() {
      return {
...
}`,...(a=(t=e.parameters)==null?void 0:t.docs)==null?void 0:a.source}}};var s,n,o;l.parameters={...l.parameters,docs:{...(s=l.parameters)==null?void 0:s.docs,source:{originalSource:`{
  name: '트리형',
  render: () => ({
    template: \`
      <div class="w-[360px] flex flex-col gap-1">
...
}`,...(o=(n=l.parameters)==null?void 0:n.docs)==null?void 0:o.source}}};const d=["SideMenu","Default"];export{l as Default,e as SideMenu,d as __namedExportsOrder,b as default};
