const m={title:"데이터 표시/ListBlockItem",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{active:{control:"boolean",description:"활성 상태"},icon:{control:"boolean",description:"아이콘 표시"},editButton:{control:"boolean",description:"편집/삭제 버튼 표시 (hover 시 노출)"},label:{control:"text",description:"아이템 텍스트"}},args:{active:!1,icon:!1,editButton:!1,label:"항목 이름"}},i={name:"ListBlockItem",render:v=>({setup(){return{args:v}},template:`
      <ul class="w-64">
    ...
    `})},t={name:"ListBlockItem — Collapsible",render:()=>({template:`
    ...
    `})},s={name:"ListBlockItem — DnD",render:()=>({template:`
    ...
    `})};var e,l,a;i.parameters={...i.parameters,docs:{...(e=i.parameters)==null?void 0:e.docs,source:{originalSource:`{
  name: 'ListBlockItem',
  render: args => ({
    setup() {
      return {
...
}`,...(a=(l=i.parameters)==null?void 0:l.docs)==null?void 0:a.source}}};var n,o,c;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`{
...
}`,...(c=(o=t.parameters)==null?void 0:o.docs)==null?void 0:c.source}}};var r,u,d;s.parameters={...s.parameters,docs:{...(r=s.parameters)==null?void 0:r.docs,source:{originalSource:`{
...
}`,...(d=(u=s.parameters)==null?void 0:u.docs)==null?void 0:d.source}}};const p=["Default","Collapsible","DnDState"];export{t as Collapsible,i as Default,s as DnDState,p as __namedExportsOrder,m as default};
