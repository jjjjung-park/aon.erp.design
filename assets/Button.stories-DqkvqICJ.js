import{x as t,n as y,T as P,P as T}from"./iframe-RcI2tPm4.js";import"./preload-helper-FI0fEOG2.js";const A={title:"기초/Button",component:t,tags:["autodocs"],argTypes:{variant:{control:"select",options:["default","destructive","outline","secondary","ghost","link"]},size:{control:"select",options:["sm","default","lg","icon-sm","icon","icon-lg"]}},args:{variant:"default",size:"default"}},n={render:w=>({components:{Button:t},setup(){return{args:w}},template:'<Button v-bind="args">버튼</Button>'})},e={name:"모든 Variant",render:()=>({components:{Button:t},template:`
    ...
    `})},o={name:"아이콘 버튼",render:()=>({components:{Button:t,LucidePlus:T,LucideTrash2:P,LucideSearch:y},template:`
      <div class="flex flex-wrap gap-3 items-end">
    ...
    `})},s={name:"텍스트 + 아이콘",render:()=>({components:{Button:t,LucidePlus:T,LucideTrash2:P},template:`
      <div class="flex flex-wrap gap-3 items-center">
...
}`,...(l=(i=n.parameters)==null?void 0:i.docs)==null?void 0:l.source}}};var c,d,B;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  name: '모든 Variant',
  render: () => ({
    components: {
      Button
