import{E as t}from"./EmptyData-Bd3VobSW.js";import{bQ as p,bK as A,bd as O,cc as a,bP as V,bi as e,Y as K,Z as M,a0 as Q,bh as d,a1 as W,a2 as Y,x as Z,a3 as q}from"./iframe-DqjGzl0i.js";import{_ as G}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-FI0fEOG2.js";const m={};function J(k,n){const z=p("LucideShieldAlert"),N=M,P=Q,R=W,$=K,C=p("LucideChevronLeft"),F=Z,j=Y,B=q;return A(),O(B,{class:"gap-16"},{default:a(()=>[V(k.$slots,"default",{},()=>[e($,null,{default:a(()=>[e(N,{variant:"icon",class:"bg-primary-light text-primary rounded-full size-[100px] [&_svg]:size-[100%] p-5"},{default:a(()=>[e(z)]),_:1}),e(P,{class:"text-xl font-bold text-primary mt-3"},{default:a(()=>[...n[0]||(n[0]=[d("화면을 찾을 수 없습니다.",-1)])]),_:1}),e(R,{class:"text-md"},{default:a(()=>[...n[1]||(n[1]=[d("관리자에게 문의 해 주세요.",-1)])]),_:1})]),_:1}),e(j,null,{default:a(()=>[e(F,{variant:"link",size:"lg",class:"text-default"},{default:a(()=>[e(C),n[2]||(n[2]=d("이전 화면으로 돌아가기",-1))]),_:1})]),_:1})])]),_:3})}const X=G(m,[["render",J]]);m.__docgenInfo=Object.assign({displayName:m.name??m.__name},{displayName:"EmptyPage",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/aon.erp.design/aon.erp.design/design-sync/src/markup/components/empty/EmptyPage.vue"]});const se={title:"UI 패턴/Empty",tags:["autodocs"],parameters:{controls:{hideNoControlsWarning:!0}}},s={name:"기본",render:()=>({components:{EmptyData:t},template:`
