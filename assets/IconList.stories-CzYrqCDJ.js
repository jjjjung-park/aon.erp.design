const a={title:"UI 패턴/list/IconList",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{iconType:{control:"radio",options:["default","success","warning"],description:"아이콘 종류"},unread:{control:"boolean",description:"읽지 않음 상태 (notification dot)"},subtitle:{control:"boolean",description:"서브타이틀 표시"},actionButton:{control:"radio",options:["더보기","삭제"],description:"우측 버튼 종류"}},args:{iconType:"default",unread:!0,subtitle:!0,actionButton:"더보기"}},t={name:"기본",render:e=>({setup(){return{args:e}},template:`
    ...
    `})};var i,s,n;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`{
  name: '기본',
  render: args => ({
    setup() {
      return {
...
}`,...(n=(s=t.parameters)==null?void 0:s.docs)==null?void 0:n.source}}};const o=["Default"];export{t as Default,o as __namedExportsOrder,a as default};
