const x={title:"Foundation/Color",tags:["autodocs"],parameters:{layout:"padded"}},e={name:"Surface — 배경색",render:()=>({template:`
    ...
    `,setup(){return{neutral:[{label:"neutral",token:"--text-neutral",hex:"#FFFFFF",bg:"var(--text-default)"},{label:"subtle",token:"--text-subtle",hex:"#BBC0C7"},{label:"muted",token:"--text-muted",hex:"#798089"},{label:"default",token:"--text-default",hex:"#192030"}],system:[{label:"brand",token:"--text-brand",hex:"#007BFF"},{label:"danger",token:"--text-danger",hex:"#F13C31",cls:"text-danger"},{label:"success",token:"--text-success",hex:"#00A035"},{label:"warning",token:"--text-warning",hex:"#F36D00"}]}}})},l={name:"Border — 테두리색",render:()=>({template:`
      <div class="flex flex-col gap-8">
        <div class="flex flex-col gap-2">
          <p class="caption text-muted font-bold uppercase tracking-wide">neutral</p>
          <div class="flex gap-3">
...
}`,...(n=(o=t.parameters)==null?void 0:o.docs)==null?void 0:n.source}}};var c,i,p;l.parameters={...l.parameters,docs:{...(c=l.parameters)==null?void 0:c.docs,source:{originalSource:`{
  name: 'Border — 테두리색',
  render: () => ({
    template: \`
      <div class="flex flex-col gap-8">
...
}`,...(p=(i=l.parameters)==null?void 0:i.docs)==null?void 0:p.source}}};const u=["Surface","Text","Border"];export{l as Border,e as Surface,t as Text,u as __namedExportsOrder,x as default};
