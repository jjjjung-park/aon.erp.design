import{bQ as s}from"./iframe-CGZVOpYz.js";import{_ as o}from"./ComboboxTag-CG-a1rdJ.js";import{_ as d}from"./DatePicker-C0wyGiLx.js";import"./preload-helper-FI0fEOG2.js";const m=[{label:"옵션 1",value:"1"},{label:"옵션 2",value:"2"},{label:"옵션 3",value:"3"},{label:"옵션 4",value:"4"}],g={title:"데이터 입력/FormItem",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{label:{control:"text",description:"라벨 텍스트"},showLabel:{control:"boolean",description:"라벨 표시"},required:{control:"boolean",description:"필수 표시 (*)"},placeholder:{control:"text",description:"플레이스홀더"},validateText:{control:"text",description:"안내/오류 메시지"},ariaInvalid:{control:"boolean",description:"에러 상태"},disabled:{control:"boolean",description:"비활성화"},readonly:{control:"boolean",description:"읽기 전용"},type:{control:"select",options:["text","comboboxTag","Checkbox","RadioGroup","DatePicker"],description:"입력 컴포넌트 타입"}},args:{label:"항목명",showLabel:!0,required:!1,placeholder:"내용을 입력해 주세요",validateText:"",ariaInvalid:!1,disabled:!1,readonly:!1,type:"text"}},e={name:"FormItem",render:i=>({components:{ComboboxTag:o,DatePicker:d},setup(){const t=s("");return{args:i,value:t,sampleItems:m}},template:`
      <div class="w-80">
        <FormItem
          v-if="args.type === 'text'"
          v-model="value"
