import{x as p,E as T,G as s,J as d,K as g}from"./iframe-DooHc6g7.js";import"./preload-helper-FI0fEOG2.js";const m={title:"오버레이/Tooltip",tags:["autodocs"],argTypes:{variant:{control:"select",options:["light","dark","primary"]}}},o={name:"모든 Variant",render:()=>({components:{Tooltip:g,TooltipContent:d,TooltipProvider:s,TooltipTrigger:T,Button:p},template:`
      <TooltipProvider>
