import{bM as a}from"./iframe-RcI2tPm4.js";import"./preload-helper-FI0fEOG2.js";const u={title:"UI 패턴/Sheet",tags:["autodocs"],parameters:{layout:"centered"}},e={name:"Index",argTypes:{title:{control:"text",description:"시트 제목"},footer:{control:"boolean",description:"하단 footer 표시"},fullScreen:{control:"boolean",description:"전체화면 버튼 표시"},columns:{control:"radio",options:["1단","2단","3단"],description:"시트 너비 단계 (1단 480px · 2단 960px · 3단 전체화면)"},actionLabel:{control:"text",description:"우측 버튼 텍스트"},actionVariant:{control:"select",options:["default","destructive","secondary","outline"],description:"우측 버튼 타입"}},args:{title:"시트 제목",footer:!0,fullScreen:!1,columns:"1단",actionLabel:"저장",actionVariant:"default"},render:l=>({setup(){const s=a(!1);return{args:l,isFullSize:s,widthMap:{"1단":"480px","2단":"960px","3단":"90vw"},heightMap:{"1단":"600px","2단":"600px","3단":"90vh"},colMap:{"1단":1,"2단":2,"3단":3}}},template:`
      <div
  ...
  argTypes: {
    ...
    columns: {
      control: 'radio',
      options: ['1단', '2단', '3단'],
      description: '시트 너비 단계 (1단 480px · 2단 960px · 3단 전체화면)'
    },
    actionLabel: {
      control: 'text',
...
}`,...(o=(i=e.parameters)==null?void 0:i.docs)==null?void 0:o.source}}};const g=["Index"];export{e as Index,g as __namedExportsOrder,u as default};
