const l={title:"데이터 표시/리스트/DataList",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{active:{control:"boolean",description:"활성 상태 (첫 번째 아이템)"},clickable:{control:"boolean",description:"호버/클릭 가능 상태"},desc:{control:"boolean",description:"설명 텍스트 (data-list__desc)"},rightColumn:{control:"radio",options:["없음","텍스트","상태배지"],description:"우측 영역"},countBadge:{control:"boolean",description:"카운터 배지"}},args:{active:!1,clickable:!1,desc:!1,rightColumn:"없음",countBadge:!1}},s={name:"DataList",render:i=>({setup(){return{args:i}},template:`
