import{x as p}from"./iframe-DqjGzl0i.js";import{a as d}from"./avatar-default-8NlzZuuD.js";import"./preload-helper-FI0fEOG2.js";const w={title:"UI 패턴/Dropdown",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{size:{control:"radio",options:["sm","default","lg"],description:"트리거 버튼 사이즈"},withLabel:{control:"boolean",description:"그룹 라벨 표시"},iconTrigger:{control:"boolean",description:"아이콘 버튼 트리거"}},args:{size:"default",withLabel:!1,iconTrigger:!1}},e={name:"기본",render:u=>({components:{Button:p},setup(){return{args:u}},template:`
      <UiDropdownMenu>
