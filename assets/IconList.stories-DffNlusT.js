const a={title:"데이터 표시/리스트/IconList",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{iconType:{control:"radio",options:["default","success","warning"],description:"아이콘 종류"},unread:{control:"boolean",description:"읽지 않음 상태 (notification dot)"},subtitle:{control:"boolean",description:"서브타이틀 표시"},actionButton:{control:"radio",options:["더보기","삭제"],description:"우측 버튼 종류"}},args:{iconType:"default",unread:!0,subtitle:!0,actionButton:"더보기"}},t={name:"IconList",render:e=>({setup(){return{args:e}},template:`
