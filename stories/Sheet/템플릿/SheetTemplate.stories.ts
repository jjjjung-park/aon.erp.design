...
export const PushAlertStory: Story = {
  name: 'Sheet — 푸시알림',
  render: () => ({
    components: { LineTabs, EmptyData },
    setup() {
      const tabList = ref([
      ...
      return { tabList, activeTab, onTabChange }
    },
    template: `
...
export const FullSheetStory: Story = {
  name: 'Sheet — 전체시트 (BOM)',
  render: () => ({
    components: { TableLayout, Th, Td, Tags },
    template: `
